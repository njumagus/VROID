...
def fast_rcnn_inference(boxes, scores, image_shapes, score_thresh, nms_thresh, topk_per_image, mode="panoptic"):
    """
    ...
    result_per_image = [
        fast_rcnn_inference_single_image(
            boxes_per_image, scores_per_image, image_shape, score_thresh, nms_thresh, topk_per_image, mode
        )
...
def fast_rcnn_inference_single_image(
    boxes, scores, image_shape, score_thresh, nms_thresh, topk_per_image, mode="panoptic"
):
    """
...
class FastRCNNOutputs(object):
    ...
    def inference(self, score_thresh, nms_thresh, topk_per_image,mode="panoptic"):
        """
        Args:
        ...
        return fast_rcnn_inference(
            boxes, scores, image_shapes, score_thresh, nms_thresh, topk_per_image, mode
        )
