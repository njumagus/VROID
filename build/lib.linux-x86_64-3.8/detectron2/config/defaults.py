...
_C.MODEL.RELATION_HEADS.RELATION_HEAD_LIST=["instance","pair","triplet"]
_C.MODEL.RELATION_HEADS.RELATION_INSTANCE_ENCODER = CN()
_C.MODEL.RELATION_HEADS.RELATION_INSTANCE_ENCODER.NAME = "InstanceEncoder1"
_C.MODEL.RELATION_HEADS.RELATION_INSTANCE_HEAD = CN()
_C.MODEL.RELATION_HEADS.RELATION_INSTANCE_HEAD.NAME = "InstanceHead14"
_C.MODEL.RELATION_HEADS.RELATION_PREDICATE_HEAD = CN()
_C.MODEL.RELATION_HEADS.RELATION_PREDICATE_HEAD.NAME = "PredicateHead45"
_C.MODEL.RELATION_HEADS.RELATION_PREDICATE_HEAD.USE_BIAS=False
_C.MODEL.RELATION_HEADS.RELATION_PREDICATE_HEAD.UNLABELED_ITERATION_THRESHOLD1 = 0
_C.MODEL.RELATION_HEADS.RELATION_PREDICATE_HEAD.UNLABELED_ITERATION_THRESHOLD2 = 240000
_C.MODEL.RELATION_HEADS.RELATION_PREDICATE_HEAD.AF=0.5
_C.MODEL.RELATION_HEADS.RELATION_PAIR_HEAD = CN()
_C.MODEL.RELATION_HEADS.RELATION_PAIR_HEAD.NAME = "PairHead17"
_C.MODEL.RELATION_HEADS.RELATION_TRIPLET_HEAD = CN()
_C.MODEL.RELATION_HEADS.RELATION_TRIPLET_HEAD.NAME = "TripletHead4"
_C.MODEL.RELATION_HEADS.RELATION_TRIPLET_HEAD.START_ITERATION_THRESHOLD=0
